...
# NEED TO TURN THIS INTO A CLASS, WITH METHODS TO:
#   RETURN HYPOTHETICAL SITUATIONS

class TEST(object):
    def __init__(self, text):
        self.text = "TEST"

    def callCollege(self):
        self.text = "THIS IS A TEST."

def someFunction(*args):
    print ("someFunction")

# global counting variable = 0; goes up to 60; if it == 60, finish/break/return
# global list of answers variable.... list_of_answers = [] 
...
def college_selection (row_number):
    ...
    return collegeArray
        # # WOULD NOT BE NECESSARY IF LIST_OF_ANSWERS WAS POPULATED VIA BUTTON CLICKS
        # while True:
