...
choices_df = pd.read_csv('/Users/jakemainwaring/Desktop/ProjectScenarios_revisedmp.csv')
...
#USER INPUT STATE 
state_choice = (input('Please select which states you are interested in exploring (separated by commas): ')).upper()
...
few_real_df = pd.read_csv('/Users/jakemainwaring/Desktop/FewRealSchools.csv')
few_real_df.head()


# In[48]:

X_few_real = few_real_df.iloc[:, 1:9]
X_few_real.head()


# In[49]:

Y_few_real = few_real_df['CHOICE']


# In[50]:

# Getting weights for the three real schools
logreg.decision_function(X_few_real)
